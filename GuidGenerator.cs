...
namespace DapperExtensions
{
    ...
    /// 3 bytes: increment
    /// </summary>
    public class GuidGeneratorDE 
    {
        // private static fields
        private static readonly GuidGeneratorDE __instance = new GuidGeneratorDE();
        ...
        /// </summary>
        public static GuidGeneratorDE Instance
        {
            get
            {
                return __instance;
